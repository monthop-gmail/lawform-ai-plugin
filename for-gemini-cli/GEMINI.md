...
5. ห้ามปล่อยช่อง `...` ว่าง ต้องร่างเนื้อหาให้ครบทุกฟอร์ม
...
| `odoo_execute` | เรียก method พิเศษ |
| `odoo_fields_get` | ดู field definitions |

## ข้อมูลระบบ

- **Odoo URL**: http://localhost:8069 (admin/admin)
- **Database**: lawform
- **MCP Endpoint**: http://localhost:8000/mcp/
- **Module**: legal_forms

## Fallback (ถ้า MCP ไม่พร้อม)
